...
DelWindow {
    ...
    Item {
        ...
        Item {
            ...
            ShaderEffect {
                anchors.fill: parent
                vertexShader: "qrc:/qt/qml/ui/shaders/effect2.vert.qsb"
                fragmentShader: "qrc:/qt/qml/ui/shaders/effect2.frag.qsb"
                opacity: 0.5
        ...
        Column {
            ...
            MySlider {
                ...
                slider.value: rootBAckground.opacity
                slider.snapMode: DelSlider.SnapOnRelease
                slider.onFirstMoved: {
                    rootBAckground.opacity = slider.currentValue;
                }
